            ...
            >
              <p>
                <Trans i18nKey="Seabed Card 1">
                  The seafloor has many unique physical seabedological features,
                  each creating habitats that support different ecological
                  communities. Plans should ensure the representative coverage
                  of each seafloor type. This report summarizes the percentage
                  of each seabedological feature found in this plan.
                </Trans>
              </p>
